    ...
    render() {
        return (
            ...
            <div className="artworkList">
                <button type="button" className="btn btn-info btn-lg addArtBtn" data-toggle="modal" data-target="#artworkListModal">Add New Artwork</button>

                <div className="modal fade" id="artworkListModal" role="dialog">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header"><h3>Add New Artwork</h3>
